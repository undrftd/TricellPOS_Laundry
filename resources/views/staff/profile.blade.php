...
<div class="container">
  ...
  <nav>
    ...
    <div class="nav nav-tabs justify-content-end memberstab" id="nav-tab" role="tablist">
      ...
      <a class="nav-item nav-link active " id="nav-profile-tab" href="/staff/preferences/profile" role="tab" aria-controls="nav-profile" aria-selected="true">Profile
...
<script type="text/javascript">
  ...
  $.ajax({
    type: 'POST',
    url: '/staff/preferences/update_profile',
    data: {
