...
<div class="container">
  ...
  <nav>
    <div class="nav nav-tabs justify-content-end memberstab" id="nav-tab" role="tablist">
      ...
      <a class="nav-item nav-link active" id="nav-discount-tab"  href="/preferences/discounts" role="tab" aria-controls="nav-discount" aria-selected="false">Discounts</a>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <form class="form ml-auto" action="/preferences/discounts/search" method="GET">
...
<script type="text/javascript">
  ...
  $.ajax({
    type: 'POST',
    url: '/preferences/update_discount',
    data: {
            '_token': $('input[name=_token]').val(),
  ...
  $.ajax({
    type: 'POST',
    url: '/preferences/delete_discount',
    data: {
      '_token': $('input[name=_token]').val(),
