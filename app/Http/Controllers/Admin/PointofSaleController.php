...
class PointofSaleController extends Controller
{
    ...
    public function index()
    {
    	...
    	return view('admin.pos')->with(['products' => $products, 'allitems' => $allitems, 'vat' => $vat,'lowstock' => $lowstock, 'discounts' => $discounts]);
    }
    ...
    public function buttonload()
    {
        $products = Product::orderBy('product_id', 'asc')->simplepaginate(32);
        $lowstock = DB::table('profile')->select('low_stock')->where('id', 1)->first();
        return view('admin.posbuttons')->with(['products' => $products, 'lowstock' => $lowstock])->render();
    }
